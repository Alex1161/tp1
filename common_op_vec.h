...
// Alinea los bytes de la clave a la cantidad de 
// bytes del mensaje y retorna su tamaño
size_t align(int *bytes_key, 
             int *bytes_key_aligned, 
             size_t size_bytes_msg, 
             size_t size_bytes_key);

// Suma byte a byte 2 arreglos del mismo tamaño 
// y los guarda en result y retorna el tamaño
size_t sum(int *bytes1, int *bytes2, int *result, size_t size);

// Resta byte a byte 2 arreglos del mismo tamaño 
// y los guarda en result y retorna el tamaño
